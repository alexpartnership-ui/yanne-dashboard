...
export function ExportButton({ type, label }: ExportButtonProps) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="flex items-center gap-1.5 rounded-md border border-zinc-300 bg-white px-3 py-1.5 text-xs font-medium text-zinc-600 hover:bg-zinc-50 disabled:opacity-50"
    >
