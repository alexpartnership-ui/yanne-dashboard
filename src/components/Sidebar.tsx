...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      {
        to: '/clients/overview', label: 'Client Overview', locked: true,
  ...
  },
  {
    ...
    items: [
      {
        to: '/outbound/email', label: 'Email Intelligence', locked: true,
      ...
      {
        to: '/outbound/copy', label: 'Copy Library', locked: true,
      ...
      {
        to: '/outbound/setters', label: 'Setter Performance', locked: true,
      ...
      {
        to: '/outbound/leads', label: 'Lead Quality', locked: true,
